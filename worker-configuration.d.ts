/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf1e3bb1f9f03790ec57537ad98afd53)
// Runtime types generated with workerd@1.20250612.0 2024-06-17 nodejs_compat,nodejs_compat_populate_process_env
declare namespace Cloudflare {
	interface Env {
		MD_CACHE: KVNamespace;
		BROWSER_DO: DurableObjectNamespace<import("./src/index").Browser>;
...
// Global types for browser context
...
declare module '@cloudflare/puppeteer' {
	...
	const puppeteer: {
		launch(binding: any): Promise<puppeteer.Browser>;
		connect(binding: any, sessionId: string): Promise<puppeteer.Browser>;
		sessions(binding: any): Promise<any[]>;
	};
